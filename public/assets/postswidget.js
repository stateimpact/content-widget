...
window.JST['story'] = _.template('<h4 class="si-story-title"><%= title %></h4><p class="si-story-meta">    <span class="si-story-author"><%= author %></span> |     <span class="si-story-date"><%= date %></span></p><p class="si-story-excerpt"><%= excerpt %></p>');
})();